...
package local_project.job_test01_0_1;
...
/**
 * Job: job_test01 Purpose: <br>
 * Description: test01 <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class job_test01 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_test01";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_test01.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	String messagetMsgBox_1 = "Hello world1!";   	
 ...
 */
    ...
    public static void main(String[] args){
        final job_test01 job_test01Class = new job_test01();

        int exitCode = job_test01Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_test01.class.getClassLoader().getResourceAsStream("local_project/job_test01_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_test01.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_test01");
        }
...
/************************************************************************************************
 *     24963 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020/04/07 17:11:34 JST
 ************************************************************************************************/