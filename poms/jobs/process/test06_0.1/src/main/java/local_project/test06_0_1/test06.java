...
package local_project.test06_0_1;
...
/**
 * Job: test06 Purpose: コンテキストの確認<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class test06 implements TalendJob {
...
public String getNew2(){
	...
	private final String jobName = "test06";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(test06.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final test06 test06Class = new test06();

        int exitCode = test06Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test06.class.getClassLoader().getResourceAsStream("local_project/test06_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = test06.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : test06");
        }
...
/************************************************************************************************
 *     25795 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020/04/07 17:56:57 JST
 ************************************************************************************************/