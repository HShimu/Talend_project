...
package local_project.job_test02_0_1;
...
/**
 * Job: job_test02 Purpose: <br>
 * Description: test02 <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class job_test02 implements TalendJob {
	...
	private final String jobName = "job_test02";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_test02.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = "Hello world2!";
	...
	public static void main(String[] args) {
		final job_test02 job_test02Class = new job_test02();

		int exitCode = job_test02Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_test02.class.getClassLoader()
					.getResourceAsStream("local_project/job_test02_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_test02.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_test02");
		}
...
/************************************************************************************************
 * 28959 characters generated by Talend Open Studio for Data Integration on the
 * 2020/04/07 16:32:39 JST
 ************************************************************************************************/